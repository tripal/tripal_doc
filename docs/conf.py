...
latex_documents = [
    (master_doc, 'Tripal4x.tex', u'Tripal 4.x Documentation',
     u'Tripal Project Management Committee with the help of the Tripal Community', 'manual'),
]
...
man_pages = [
    (master_doc, 'tripal4x', u'Tripal 4.x Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Tripal4x', u'Tripal 4.x Documentation',
     author, 'Tripal4x', 'One line description of project.',
     'Miscellaneous'),
]
