...
.. toctree::
   ...
   ### not needed / example_genomic/importing_publications
   ### not needed / example_genomic/functional_annotations
...
.. note::
As a rule, extension modules are not documented in the Tripal User’s Guide. You can find documentation for extension modules that enhance Tripal functionality on the Extension Modules page. However, to provide a functioning demonstration the three analysis extension modules are described here.
