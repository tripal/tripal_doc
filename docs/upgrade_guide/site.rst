...
**What we know so far:**
 ...
 - Upgrading from Drupal 7 to 10+ requires a migration.
    ...
    - This means you will create a local copy of your current Drupal 7 site, a new Drupal 10+ site and then use the Drupal Migration module to transfer your data from the Drupal 7 site to the new Drupal 10 one.
